...
from .DeepQ_mod_action import DQN_mod_action
        

class DQN_Nstep_mod_action(DQN_mod_action):

    def __init__(self, conf, action_size, state_size, device):
        super(DQN_Nstep_mod_action, self).__init__(conf, action_size, state_size, device)
