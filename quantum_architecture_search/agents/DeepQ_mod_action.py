...
from utils import dictionary_of_actions_rxx_ryy_rzz


class DQN_mod_action(object):
    ...
    def __init__(self, conf, action_size, state_size, device):
        ...
        self.translate = dictionary_of_actions_rxx_ryy_rzz(self.num_qubits)
        self.rev_translate = dictionary_of_actions_rxx_ryy_rzz(self.num_qubits)
