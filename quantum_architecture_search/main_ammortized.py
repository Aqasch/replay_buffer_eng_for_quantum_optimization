...
from environment_ammortized import CircuitEnv
import agents
import time
...
def one_episode(episode_no, env, agent, episodes):
    ...
    for itr in range(env.num_layers + 1):
        ...
        # agent.saver.stats_file['train'][episode_no]['t_energy'].append(env.t_energy_last)
        # agent.saver.stats_file['train'][episode_no]['t_opt'].append(env.t_opt_last)
